...
export default function Hero() {
  return (
    <div className="flex:col md:flex lg:first-letter:flex w-full md:justify-between mx-auto items-center">
      <div className="md:w-1/2 h-fit flex flex-col justify-center gap-5 mb-8">
        ...
        <p className="sm:text-sm">A creative and collaborative enterprise shaping the society towards a more enjoyable life We are on a mission to be an agent of joy, happiness and the good life</p>
        <Link href={"/users"}>
